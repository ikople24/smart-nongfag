  ...
  return (
    <div className="flex flex-col space-y-2">
      <div className="flex flex-col space-y-2 mt-2">
        ...
        <textarea
          className="textarea w-full bg-blue-50 text-blue-900 border-blue-300 placeholder:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="flex flex-col space-y-2 mt-2">
        ...
        <div className="flex gap-2">
          ...
          <div className="flex flex-1 flex-col">
            ...
            <input
              type="text"
              className="input input-bordered flex-1 bg-blue-50 text-blue-900 border-blue-300 placeholder:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="flex flex-col space-y-2 mt-2">
        ...
        <div className="relative w-full">
          <input
            type="tel"
            className="input input-bordered w-full bg-blue-50 text-blue-900 border-blue-300 placeholder:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 pl-10 tabular-nums"
